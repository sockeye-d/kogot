...
public final class GDExtensionCallableCustomCall {
    ...
    private static final FunctionDescriptor $DESC = FunctionDescriptor.ofVoid(
            FFMUtils.C_POINTER, FFMUtils.C_POINTER, FFMUtils.C_LONG, FFMUtils.C_POINTER, FFMUtils.C_POINTER);
    ...
    private static final MethodHandle UP$MH =
            FFMUtils.upcallHandle(GDExtensionCallableCustomCall.Function.class, "apply", $DESC);
