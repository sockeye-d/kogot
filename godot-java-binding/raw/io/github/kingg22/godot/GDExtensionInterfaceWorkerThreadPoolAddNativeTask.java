...
public final class GDExtensionInterfaceWorkerThreadPoolAddNativeTask {
    ...
    private static final MethodHandle UP$MH = gdextension_interface_h.upcallHandle(GDExtensionInterfaceWorkerThreadPoolAddNativeTask.Function.class, "apply", $DESC);
