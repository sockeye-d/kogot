 ...
 * }
 */
public class GDExtensionGodotVersion2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gdextension_interface_h.C_INT.withName("major"),
        gdextension_interface_h.C_INT.withName("minor"),
        gdextension_interface_h.C_INT.withName("patch"),
        gdextension_interface_h.C_INT.withName("hex"),
        gdextension_interface_h.C_POINTER.withName("status"),
        gdextension_interface_h.C_POINTER.withName("build"),
        gdextension_interface_h.C_POINTER.withName("hash"),
        gdextension_interface_h.C_LONG.withName("timestamp"),
        gdextension_interface_h.C_POINTER.withName("string")
    ).withName("$anon$804:9");
