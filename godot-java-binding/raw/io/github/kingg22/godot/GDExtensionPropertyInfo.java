...
public class GDExtensionPropertyInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gdextension_interface_h.C_INT.withName("type"),
        MemoryLayout.paddingLayout(4),
        gdextension_interface_h.C_POINTER.withName("name"),
        gdextension_interface_h.C_POINTER.withName("class_name"),
        gdextension_interface_h.C_INT.withName("hint"),
        MemoryLayout.paddingLayout(4),
        gdextension_interface_h.C_POINTER.withName("hint_string"),
        gdextension_interface_h.C_INT.withName("usage"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$235:9");
