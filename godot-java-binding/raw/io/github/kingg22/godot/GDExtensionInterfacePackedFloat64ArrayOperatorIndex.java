...
public final class GDExtensionInterfacePackedFloat64ArrayOperatorIndex {
    ...
    private static final MethodHandle UP$MH = gdextension_interface_h.upcallHandle(GDExtensionInterfacePackedFloat64ArrayOperatorIndex.Function.class, "apply", $DESC);
