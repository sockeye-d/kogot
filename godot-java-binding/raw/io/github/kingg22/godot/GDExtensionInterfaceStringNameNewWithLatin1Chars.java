...
public final class GDExtensionInterfaceStringNameNewWithLatin1Chars {
    ...
    private static final MethodHandle UP$MH = gdextension_interface_h.upcallHandle(GDExtensionInterfaceStringNameNewWithLatin1Chars.Function.class, "apply", $DESC);
