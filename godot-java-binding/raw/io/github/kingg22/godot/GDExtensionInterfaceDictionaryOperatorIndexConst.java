...
public final class GDExtensionInterfaceDictionaryOperatorIndexConst {
    ...
    private static final MethodHandle UP$MH = gdextension_interface_h.upcallHandle(GDExtensionInterfaceDictionaryOperatorIndexConst.Function.class, "apply", $DESC);
