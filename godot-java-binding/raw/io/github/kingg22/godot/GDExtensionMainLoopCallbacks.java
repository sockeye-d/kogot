 ...
 * }
 */
public class GDExtensionMainLoopCallbacks {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        gdextension_interface_h.C_POINTER.withName("startup_func"),
        gdextension_interface_h.C_POINTER.withName("shutdown_func"),
        gdextension_interface_h.C_POINTER.withName("frame_func")
    ).withName("$anon$825:9");
