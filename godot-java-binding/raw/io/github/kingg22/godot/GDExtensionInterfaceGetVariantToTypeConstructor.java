...
public final class GDExtensionInterfaceGetVariantToTypeConstructor {
    ...
    private static final MethodHandle UP$MH = gdextension_interface_h.upcallHandle(GDExtensionInterfaceGetVariantToTypeConstructor.Function.class, "apply", $DESC);
